...
global_1.Global.initializeCLI().then(function () {
    program
        ...
        return __awaiter(this, void 0, void 0, function () {
            var utterance, i, arg, options, token, locale, voiceID, virtualDeviceResponse, ex_1, displayMessage, Logger, nodeId;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ex_1 = _a.sent();
                        if (ex_1.message === "Token Required") {
                            ...
                            logging_helper_1.LoggingHelper.error(Logger, ex_1);
                        }
                        process.exit(0);
                        return [2];
                    case 4:
