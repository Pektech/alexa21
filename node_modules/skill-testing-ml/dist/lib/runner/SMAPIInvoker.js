...
module.exports =
/*#__PURE__*/
function (_invoker$Invoker) {
  _inherits(SMAPIInvoker, _invoker$Invoker);

  function SMAPIInvoker() {
    _classCallCheck(this, SMAPIInvoker);

    return _possibleConstructorReturn(this, _getPrototypeOf(SMAPIInvoker).apply(this, arguments));
  }
...
var SMAPIInvokerResponse =
/*#__PURE__*/
function (_invoker$InvokerRespo) {
  ...
  function SMAPIInvokerResponse(interaction, sourceJSON) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(SMAPIInvokerResponse).call(this, interaction, skillResponse));
  }
