...
/*#__PURE__*/
function (_Error) {
  _inherits(FrameworkError, _Error);

  function FrameworkError(message) {
    var _this;

    _classCallCheck(this, FrameworkError);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(FrameworkError).call(this, message)); // For compatibility with older node versions, set a type variable we can check

    _this.type = "FrameworkError";
    return _this;
  }
